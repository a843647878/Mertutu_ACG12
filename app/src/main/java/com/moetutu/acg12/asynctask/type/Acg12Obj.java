...
public class Acg12Obj{

	private int ID;
	private AcgUserObj user;
	private String msg;
	private String status;
	private AcgPost post;
	private AcgPostAuthor post_author;
	...
	private List<AcgCategoriesObj> post_categories;
	private String url;
	private AcgThumbnailObj thumbnail;
	...
	public AcgUserObj getUser() {
		return user;
	}
	public void setUser(AcgUserObj user) {
		this.user = user;
	}
	...
	public AcgPost getPost() {
		return post;
	}
	public void setPost(AcgPost post) {
		this.post = post;
	}
	public AcgPostAuthor getPost_author() {
		return post_author;
	}
	public void setPost_author(AcgPostAuthor post_author) {
	...
	public List<AcgCategoriesObj> getPost_categories() {
		return post_categories;
	}
	public void setPost_categories(List<AcgCategoriesObj> post_categories) {
	...
	public AcgThumbnailObj getThumbnail() {
		return thumbnail;
	}
	public void setThumbnail(AcgThumbnailObj thumbnail) {
