...
public class CommentsAdapter extends BaseArrayRecyclerAdapter<CommentEntity> {
    @Override
...
//        tv_content.setText(commentEntity.getContent());
        ...
        if (commentEntity.children.size()>0){
            ...
            children_rv.setAdapter(articleAdapter);
            articleAdapter.bindData(true,commentEntity.children);
        }else {
